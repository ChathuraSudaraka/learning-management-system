    ...
    <div class="space-y-4">
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="sm:col-span-3 space-y-1">
          ...
          <p class="text-gray-600 dark:text-zinc-400">Browse and redeem your earned points for exciting rewards and educational resources</p>
        </div>
        <UInput
          v-model="searchQuery"
    ...
    <UModal v-model="showRedemptionModal">
      <div class="space-y-4">
        ...
        <p class="text-gray-600 dark:text-zinc-400">
          Are you sure you want to redeem {{ selectedProduct?.title }} for
        ...
        <div class="flex justify-end space-x-3">
          ...
          <UButton color="blue" @click="confirmRedemption"> Confirm </UButton>
        </div>
      </div>
    </UModal>
  </div>
